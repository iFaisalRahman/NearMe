...
-(void)connection:(NSURLConnection*)connection didReceiveData:(NSData*)data {
  [_responseText appendData:data];
	...
	NSString *content = [[NSString alloc]  initWithBytes:[_responseText bytes] length:[_responseText length] encoding: NSUTF8StringEncoding];
	
	NSLog(@"Response text %s",content);
}
